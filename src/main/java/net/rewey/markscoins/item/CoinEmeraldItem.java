...
import net.rewey.markscoins.procedures.CoinEmeraldItemInInventoryTickProcedure;
...
public class CoinEmeraldItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("1,048,576 WP"));
	}

	@Override
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		super.inventoryTick(itemstack, world, entity, slot, selected);
		CoinEmeraldItemInInventoryTickProcedure.execute(entity);
	}
}
